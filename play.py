...
import multiprocessing, os, argparse, sys
...
class player:
    ...
    def handle_arg(self, args):
        ...
        if args.h == True:
            self.console.print(self.read_help(), style="blue")
            ...
            self.console.print(self.read_help(), style=" italic blue")
    ...
    def get_arg(self):
        ...
        parser = argparse.ArgumentParser(description="A Tool that play music from you system", exit_on_error=True)
